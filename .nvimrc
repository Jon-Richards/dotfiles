" NOTE: As of this writing, NeoVim does not use ~/.nvimrc by default.  To find
" where NeoVim looks for its config file, run `:h vimrc`.  It may be necessary
" to symlink a `~/.nvimrc` to that location.
...
" Coc
highlight CocInfoSign ctermbg=black ctermfg=grey
